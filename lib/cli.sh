...
readonly SCRIPT_COMMANDS=(shell create slot slots revoke profiles projects profile info help -h --help add remove install allowlist clean save project tmux kill doctor snapshot setup auth tunnel vm agent mcp import unlink)
...
get_command_requirements() {
    ...
    case "$cmd" in
        ...
        profiles|projects|help|-h|--help|slots|create|revoke|clean|import|unlink|kill|auth|tunnel|setup|vm|doctor)
            echo "none"
            ;;
